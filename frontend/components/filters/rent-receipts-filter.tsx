...
export interface RentReceiptFiltersState {
  search: string;
  period: string;
  fromDate: string;
  toDate: string;
...
interface RentReceiptFiltersProps {
  filters: RentReceiptFiltersState;
  onFiltersChange: (filters: RentReceiptFiltersState) => void;
  onReset: () => void;
}

export function RentReceiptFilters({
  filters,
  onFiltersChange,
  onReset,
}: RentReceiptFiltersProps) {
  const handleFilterChange = (key: keyof RentReceiptFiltersState, value: string | boolean) => {
    onFiltersChange({
      ...filters,
      [key]: value,
    });
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            value={filters.tenantResident}
            onChange={(e) => handleFilterChange('tenantResident', e.target.value)}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            value={filters.unitSpace}
            onChange={(e) => handleFilterChange('unitSpace', e.target.value)}
          />
        </div>
